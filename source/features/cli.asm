...
get_cmd:				; Main processing loop
	...
	;tri modify----------------------------------
	mov di, dird_string		; 'DIRD' entered?
	call os_string_compare
	jc near list_directory_deleted
	;tri modify----------------------------------
...
; tri modify------------------------------------------------------------------
list_directory_deleted:
	mov cx,	0			; Counter

	mov ax, dirlist			; Get list of files on disk
	mov bx, 1			; set show deleted flag
	call os_get_file_list
...
; ------------------------------------------------------------------
	...
	cls_string		db 'CLS', 0
	dir_string		db 'DIR', 0
	dird_string		db 'DIRD', 0	;tri modify
